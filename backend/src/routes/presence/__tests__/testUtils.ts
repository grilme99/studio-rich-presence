/**
 * Shared test utilities for presence route tests.
 */

import { Hono } from 'hono';
import { presenceRouter } from '../index';
...
/**
 * Create test app with presence routes mounted.
 */
...
export async function createTestUser(
    ...
    options: {
        ...
        pendingTokenExpires?: number | null;
    } = {}
): Promise<string> {
...
export async function createTestDiscordAccount(
    ...
    const tokenExpiresAt = options.tokenExpiresAt ?? (now + 3600000); // 1 hour from now
